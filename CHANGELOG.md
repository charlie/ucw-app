...
- Widget was showing and recording success if a user exits Plaid Link before a connection was made.
...
- Plaid identity data endpoint for future plaid support
...
- Disabled Plaid adapter by default due to security risk

## [1.15.0]

### Added

- Plaid Accounts data endpoint

## [1.14.1]

### Added

- Tests around performance resilience member cleanup on 404 response

## [1.14.0]

### Added

- Duration performance recording for Plaid

## [1.13.4]

### Added

- E2E tests for finicity performance measurement

## [1.13.3]

### Added

- Debug logging when retrieving an institution fails

## [1.13.2]

### Fixed

- sharedStaging and sharedProduction env files now take priority over staging and production env files.
...
- utils-cypress to utils-e2e with both cypress and playwright test utils

## [1.12.2]

### Added

- A github action to run npm audit and fail on high or critical vulnerabilities
